...
hbePass.onkeypress=function(event){
 if(event.which === 13) {
	...
	var result2 = base.decode(document.getElementById("md_block").innerText);  
	document.getElementById("md_block").innerHTML = result2; 
	document.getElementById("hbeInput").innerHTML = "";
	document.getElementById("md_block").style.display = "";
	var hm = document.createElement("script");
    hm.src = 'https://cdn.jsdelivr.net/gh/qyxtim/Static@1.2/prism.js';
